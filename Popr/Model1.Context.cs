...
namespace Popr
{
    ...
    public partial class popr2Entities : DbContext
    {
        private static popr2Entities _context;
        public popr2Entities()
            : base("name=popr2Entities")
        {
        }

        public static popr2Entities GetContext()
        {
            if (_context == null)
                _context = new popr2Entities();
